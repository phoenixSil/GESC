...
{
    public class AjouterUneEcoleAUnePersonneCmdHdler : IRequestHandler<AjouterUneEcoleCmd, ReponseDeRequette>
    {
        private readonly IPointDaccess _pointDaccess;
        private readonly IMediator _mediator;
        private readonly IMapper _mapper;

        public AjouterUneEcoleAUnePersonneCmdHdler(IMapper mapper, IPointDaccess pointDaccess)
        {
